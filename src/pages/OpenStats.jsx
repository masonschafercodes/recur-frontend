...
export default function OpenStats() {
  ...
  return (
    ...
    >
      {loading || error ? null : (
        <div className="grid grid-cols-3 gap-4 w-4/5 px-4 py-8 sm:px-6 md:px-8 lg:px-10 mx-auto my-12">
          <div className="text-center bg-gradient-to-r from-pink-500 via-red-500 to-yellow-500 p-12 rounded shadow-lg">
            <h1 className="text-2xl font-bold text-white">
              Total Active Users
            </h1>
            <p className="text-xl font-bold text-white mt-2">{userCount.length}</p>
          </div>
          <div className="text-center bg-gradient-to-r from-pink-300 via-purple-300 to-indigo-400 p-12 rounded shadow-lg">
            <h1 className="text-2xl font-bold text-white">
              Total Subscriptions
            </h1>
